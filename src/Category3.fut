...
let path [t] (r: [t]f64) (s0: f64) (f: (f64,f64) -> f64): [t]f64 =
  cumsum r |> indexed |> map f |> map f64.exp |> map (*s0)
...
let category3 [n] [l] (g: rng) (p: payoff) (t: i32) (v: [n][l]f64): (rng,f64,f64,i32,[]scenario) =
  ...
  -- Build a path for each underlying with the resimulated returns and apply the payout function
  ...
  -- TODO: intermediate holding periods for scenarios (Annex IV, 24)
