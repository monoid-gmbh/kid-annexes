...
-- ==
-- entry: test_moments
-- compiled input @ data_SX5E.in
-- output { 3027.870319209062 133007.38828307952 -1.590255977359295e7 4.950404188643979e10 364.70177992858703 -0.3278335435110392 -0.20173314791222907 }

entry test_moments (v: []f64): (f64, f64, f64, f64, f64, f64, f64) = moments v
-- ==
...
entry test_category2 (v: []f64): (f64, f64, i64, i64, [4]f64) =
  let (var, vev, mrm, sce) = category2 1.0 v
   in (var, vev, mrm, length sce, sce[0])
-- ==
